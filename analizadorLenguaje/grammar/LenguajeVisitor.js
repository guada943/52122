...
export default class LenguajeVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by LenguajeParser#funcion.
	visitFuncion(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by LenguajeParser#operacion_texto.
	visitOperacion_texto(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by LenguajeParser#transformacion.
	...
	// Visit a parse tree produced by LenguajeParser#valor.
	visitValor(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by LenguajeParser#texto.
	visitTexto(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by LenguajeParser#nombre.
	visitNombre(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by LenguajeParser#variable.
	visitVariable(ctx) {
	  return this.visitChildren(ctx);
	}
